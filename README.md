...
- a local MCP server with 61 documented, safety-classified tools
...
- Safety policy classifies all 61 tools by class, resolver, write capability, and subprocess use — see `docs/TOOL_SAFETY.md`
...
Expected response lists all 61 MCP tools with descriptions.
...
The local MCP server exposes 61 tools across five safety classes. See [`docs/TOOL_SAFETY.md`](docs/TOOL_SAFETY.md) for the full classification.
