...
v1.4.0 — semantic memory layer. 75 tools, durable knowledge store injected
...
- a local MCP server with 75 documented, safety-classified tools
...
- Safety policy classifies all 75 tools by class, resolver, write capability, and subprocess use — see `docs/TOOL_SAFETY.md`
...
Expected response lists all 75 MCP tools with descriptions.
...
The local MCP server exposes 75 tools across five safety classes. See [`docs/TOOL_SAFETY.md`](docs/TOOL_SAFETY.md) for the full classification.
